...
AWS_REGION=$AWS_REGION helm s3 init s3://microservices-app-helm-charts-rchittep/stable/myapp || echo "Init helm repo"
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://microservices-app-helm-charts-rchittep/stable/myapp/ || echo "repository name already exists"
